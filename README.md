# MongoDB Connector for STAS (Smart Test Auto Studio)
...
**Note:** Update **${smart-testauto-mongodb-connector.version}** string with the specific version like **8.0.0**. You can find more details about it on Maven Central or Github Releases under the artifact **smart-testauto-mongodb-connector**.
